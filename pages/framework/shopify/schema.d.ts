...
export type AssociateCustomerWithCheckoutMutation = {
  ...
  checkoutCustomerAssociateV2?: Maybe<
    { __typename?: 'CheckoutCustomerAssociateV2Payload' } & {
      ...
      checkoutUserErrors: Array<{ __typename?: 'CheckoutUserError' } & Pick<CheckoutUserError, 'code' | 'field' | 'message'>>;
...
export type CustomerAccessTokenCreateMutation = { __typename?: 'Mutation' } & {
  customerAccessTokenCreate?: Maybe<
    { __typename?: 'CustomerAccessTokenCreatePayload' } & {
      customerAccessToken?: Maybe<{ __typename?: 'CustomerAccessToken' } & Pick<CustomerAccessToken, 'accessToken' | 'expiresAt'>>;
      customerUserErrors: Array<{ __typename?: 'CustomerUserError' } & Pick<CustomerUserError, 'code' | 'field' | 'message'>>;
    }
  >;
};
...
export type CustomerAccessTokenDeleteMutation = { __typename?: 'Mutation' } & {
  customerAccessTokenDelete?: Maybe<
    { __typename?: 'CustomerAccessTokenDeletePayload' } & Pick<CustomerAccessTokenDeletePayload, 'deletedAccessToken' | 'deletedCustomerAccessTokenId'> & {
        userErrors: Array<{ __typename?: 'UserError' } & Pick<UserError, 'field' | 'message'>>;
      }
  >;
};
...
export type GetSiteCollectionsQuery = { __typename?: 'QueryRoot' } & {
  collections: { __typename?: 'CollectionConnection' } & {
    edges: Array<
      { __typename?: 'CollectionEdge' } & {
        node: { __typename?: 'Collection' } & Pick<Collection, 'id' | 'title' | 'handle'>;
      }
    >;
  };
};
...
export type ProductConnectionFragment = { __typename?: 'ProductConnection' } & {
  ...
  edges: Array<
    { __typename?: 'ProductEdge' } & {
      node: { __typename?: 'Product' } & Pick<Product, 'id' | 'title' | 'vendor' | 'handle'> & {
...
export type CheckoutDetailsFragment = { __typename?: 'Checkout' } & Pick<Checkout, 'id' | 'webUrl' | 'completedAt' | 'createdAt' | 'taxesIncluded'> & {
          ...
          node: { __typename?: 'CheckoutLineItem' } & Pick<CheckoutLineItem, 'id' | 'title' | 'quantity'> & {
              variant?: Maybe<
                { __typename?: 'ProductVariant' } & Pick<ProductVariant, 'id' | 'sku' | 'title'> & {
                    image?: Maybe<{ __typename?: 'Image' } & Pick<Image, 'originalSrc' | 'altText' | 'width' | 'height'>>;
...
export type GetCustomerQuery = { __typename?: 'QueryRoot' } & {
  customer?: Maybe<{ __typename?: 'Customer' } & Pick<Customer, 'id' | 'firstName' | 'lastName' | 'displayName' | 'email' | 'phone' | 'tags' | 'acceptsMarketing' | 'createdAt'>>;
};
...
export type GetPageQuery = { __typename?: 'QueryRoot' } & {
  node?: Maybe<
    ...
    | ({ __typename?: 'Model3d' } & Pick<Model3d, 'id'>)
    | ({ __typename?: 'Order' } & Pick<Order, 'id'>)
    | ({ __typename?: 'Page' } & Pick<Page, 'title' | 'handle' | 'body' | 'bodySummary' | 'id'>)
    | ({ __typename?: 'Payment' } & Pick<Payment, 'id'>)
    | ({ __typename?: 'Product' } & Pick<Product, 'id'>)
    | ({ __typename?: 'ProductOption' } & Pick<ProductOption, 'id'>)
    | ({ __typename?: 'ProductVariant' } & Pick<ProductVariant, 'id'>)
...
export type GetProductBySlugQuery = { __typename?: 'QueryRoot' } & {
  productByHandle?: Maybe<
    { __typename?: 'Product' } & Pick<Product, 'id' | 'handle' | 'title' | 'productType' | 'vendor' | 'description' | 'descriptionHtml'> & {
